...
const main__game = function () {
    ...
    caressing_sound = document.querySelector('.caressing-sound');
        ...
        let massage__pet__hungry = document.querySelector('.massage__pet__hungry').style;
    function half() {
    ...
    setInterval(function () {
        if (alive == true) {
            ...
            checkDangerH();
            half();
            if(ctMaxVM * 0.5 > ctCurVM){//kiểm tra thanh đồ ăn dưới 50%
    ...
    */
    ...
    //Tao Object
    const shop__food = [shop__food__1, shop__food__2, shop__food__3, shop__food__4];
    const value__food = [value__food__1, value__food__2, value__food__3, value__food__4];

    const shop__toys = [shop__toys__1, shop__toys__2, shop__toys__3, shop__toys__4];
    const value__toys = [value__toys__1, value__toys__2, value__toys__3, value__toys__4];
